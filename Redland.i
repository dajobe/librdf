...
%newobject librdf_new_node_from_uri_local_name;
%newobject librdf_new_node_from_normalised_uri_string;
...
int librdf_model_add_string_literal_statement(librdf_model* model, librdf_node* subject, librdf_node* predicate, const char* literal, const char *inStrOrNull /* xml_language */ =NULL, int is_wf_xml =0);
int librdf_model_add_typed_literal_statement(librdf_model* model, librdf_node* subject, librdf_node* predicate, char* string, char* inStrOrNull /* xml_language */, librdf_uri *inUriOrNull /* datatype_uri */ =NULL);
