...
librdf_node* librdf_new_node_from_literal(librdf_world *world, char *string, char *xml_language, int unused1, int is_wf_xml);
...
int librdf_node_set_literal_value(librdf_node* node, char* value, char *xml_language, int unused1, int is_wf_xml);
...
int librdf_model_add_string_literal_statement(librdf_model* model, librdf_node* subject, librdf_node* predicate, char* string, char *xml_language, int unused1, int is_wf_xml);
