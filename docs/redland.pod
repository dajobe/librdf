...
This manual page lists most of the redland 0.9.15 functions for the C
API but does not claim to be a complete summary of the entire API at
this time.  For the complete API with full details of the function
interface, see the HTML API documentation either on the Redland web
site at L<http://www.redland.opensource.ac.uk/> or with the software
release in the docs/api directory.  Documentation on the Perl and
Python APIs in POD and Pydoc respectively are also available.
...
Institute for Learning and Research Technology L<http://www.ilrt.bristol.ac.uk/>,
University of Bristol, L<http://www.bristol.ac.uk/>
