...
static const unsigned int librdf_hash_initial_capacity = 8;
...
{
  librdf_hash_memory_cursor_context *cursor;
  cursor = (librdf_hash_memory_cursor_context*)cursor_context;
                              ...
                              unsigned int flags)
{
  ...
  cursor = (librdf_hash_memory_cursor_context*)context;
