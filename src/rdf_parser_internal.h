...
struct librdf_parser_factory_s 
{
  ...
  int (*parse_iostream_into_model)(void *_context, const raptor_iostream *iostream, librdf_uri* base_uri, librdf_model *model);
  librdf_stream* (*parse_iostream_as_stream)(void *_context, const raptor_iostream *iostream, librdf_uri *base_uri);
